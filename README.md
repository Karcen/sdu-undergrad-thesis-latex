...
# You can use template in [TexPage](https://www.texpage.com/zh/template/82c4dc27-9cac-47eb-9bb5-6b5f50705131) directly.
...
> ⚠️ **为什么要做这个模板？**
> Overleaf 和 TeXPage 上现有的山大本科毕业论文 LaTeX 模板长期未维护，实测存在明显 bug，包括但不限于：字体配置错误、中文标点全半角混乱、`tocloft` 与 `ctex` 目录冲突、`bicaption` 双语题注报错、`caption` 字号不符合规范等，**导致论文格式检测无法通过**。本模板从零整理，修复了上述全部已知问题，开箱即用。
